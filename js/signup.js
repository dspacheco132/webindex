...
function cadastrar(){
  if(validNome && validUtilizador && validSenha && validConfirmSenha){
    let listaUser = JSON.parse(localStorage.getItem('listaUser') || '[]')
    
    listaUser.push(
    {
      nomeCad: nome.value,
      userCad: utilizador.value,
    ...
    msgError.innerHTML = '<strong>Preencha todos os campos corretamente antes de se registar</strong>'
